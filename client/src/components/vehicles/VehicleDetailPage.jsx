  ...
  return (
    <div className="container">
          ...
          <div className="card-body">
            {editing ? (
              <form onSubmit={handleUpdate}>
                {['make', 'model', 'year', 'licensePlate', 'color', 'capacity', 'type'].map(
                  (field) => (
            ...
            <div className="card-body">
              {vehicle.driver ? (
                <div>
                  ...
                  <p className="text-muted text-sm">
                    License: {vehicle.driver.licenseNumber || 'N/A'}
                  </p>
                  <Link
                    to={`/drivers/${vehicle.driver._id}`}
      ...
      <div className="card">
        ...
        <div className="card-body">
          {orders.length === 0 ? (
            <p className="text-muted text-center">No orders for this vehicle</p>
          ) : (
